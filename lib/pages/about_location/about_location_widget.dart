...
class _AboutLocationWidgetState extends State<AboutLocationWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AboutLocationModel());
              ...
              Align(
                ...
                child: FlutterFlowDropDown<String>(
                  ...
                  controller: _model.dropDownValueController ??=
                    ...
                    _model.dropDownValue ??= '동물원',
                  ),
                  optionsHasValueKeys: true,
                  options: List<String>.from(['동물원', '카페', '도서관', '기타']),
                  optionLabels: ['동물원', '카페', '도서관', '기타'],
                  onChanged: (val) =>
                  ...
                  onPressed: () async {
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('장소 등록 완료'),
                          content: Text('이 장소에서 자주 들리는 소리도 함께 등록해 주세요!'),
                          actions: [
                            TextButton(
                              onPressed: () =>
