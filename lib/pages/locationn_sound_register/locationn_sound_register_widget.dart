...
class LocationnSoundRegisterWidget extends StatefulWidget {
  ...
  @override
  State<LocationnSoundRegisterWidget> createState() =>
      _LocationnSoundRegisterWidgetState();
}

class _LocationnSoundRegisterWidgetState
    extends State<LocationnSoundRegisterWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LocationnSoundRegisterModel());
                ...
                Align(
                  ...
                  child: FlutterFlowDropDown<String>(
                    ...
                    options: List<String>.from(
                        ['Option 1', 'Option 2', 'Option 3', 'Others']),
                    optionLabels: ['아기 울음 소리', '코끼리 소리', '자동차 경적 소리', '기타'],
                    onChanged: (val) =>
